...
// Proga.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CProgaApp, CWinApp)
...
// Единственный объект CProgaApp

CProgaApp theApp;


// Инициализация CProgaApp

BOOL CProgaApp::InitInstance()
{
